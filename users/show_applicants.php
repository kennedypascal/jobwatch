...
if(isset($_GET['id'])) {
    ...
    $getApplicants = $conn->query("SELECT * FROM job_application WHERE company_id = '$id'");
    $getApplicants->execute();

    $getApplicants = $getApplicants->fetchAll(PDO::FETCH_OBJ);
...
<section class="site-section">
      <div class="container">
        <ul class="job-listings mb-5">
            <?php foreach($getApplicants as $jobApp) : ?>
