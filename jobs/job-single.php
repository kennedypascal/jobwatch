...
if(isset($_POST['submit_application'])) {
  ...
  $insert = $conn->prepare("INSERT INTO job_application (username, email, cv, worker_id, job_id, job_title, company_id) VALUES (:username, :email, :cv, :worker_id, :job_id, :job_title, :company_id)");
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <?php if(isset($_SESSION['username'])) : ?>
              ...
              <div class="col-6">
                <a herf="job-save.php?job_id=<?php echo $id; ?>&workerid=<?php echo $_SESSION['id']; ?>&status=save" class="btn btn-block btn-light btn-md"><i class="icon-heart"></i>Save Job</a>
                <!--add text-danger to it to make it read-->
              </div>
              <?php else : ?>
                <div class="col-6">
                <a herf="job-save.php?job_id=<?php echo $id; ?>&workerid=<?php echo $_SESSION['id']; ?>&status=delete" class="btn btn-block btn-light btn-md"><i class="icon-heart text-danger"></i>Saved Job</a>
                <!--add text-danger to it to make it read-->
              </div>
              <?php endif; ?>
          ...
          <div class="col-lg-4">
            ...
            <div class="bg-light p-3 border rounded mb-4 mt-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <a target="_blank" href="<?php echo APPURL; ?>/categories/show-jobs.php?name=<?php echo $category->name; ?>"><li class="mb-2"><strong class="text-black"><?php echo ucfirst($category->name); ?></li></a>
                <?php endforeach; ?>
